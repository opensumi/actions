...
var createVersionText = (type = "Pre-Release", version) => {
  return `<!-- versionInfo: ${type} | ${version} -->
\u{1F389} ${type} version ${version}  publish successful! You can install this version via \`npm install package@${version}\`
...
var readSummary = () => {
  ...
  return (0, import_fs.readFileSync)(process.env.GITHUB_STEP_SUMMARY).toString();
};
