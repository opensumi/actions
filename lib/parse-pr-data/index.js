...
call(async ({ github, context: context2, core: core2, meta }) => {
  const owner = core2.getInput("owner");
  const repo = core2.getInput("repo");
  const pullNumber = parseInt(core2.getInput("pull_number"));
  ...
  core2.setOutput("head_sha", headSha);
  core2.setOutput("base_sha", baseSha);
  core2.setOutput("title", data.title);
  core2.setOutput("body", data.body);
});
