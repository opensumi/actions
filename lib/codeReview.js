...
var require_dist_node15 = __commonJS({
  "node_modules/@octokit/rest/dist-node/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var core2 = require_dist_node11();
    var pluginRequestLog = require_dist_node12();
    var pluginPaginateRest = require_dist_node13();
...
// src/codeReview.ts
var import_rest = __toESM(require_dist_node15());
...
async function call(asyncFunction, callOptions = {}) {
  ...
  const github = (0, import_github.getOctokit)(token, opts);
  const meta = {
...
call(async ({ github, context: context2, core: core2 }) => {
  ...
  const token = getGitHubToken();
  const octo = new import_rest.Octokit({
    auth: token
  });
  ...
  try {
    const msg = await generateCodeReview(title, body, diff);
