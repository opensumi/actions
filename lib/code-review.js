...
var require_dist_node9 = __commonJS({
  "node_modules/@actions/github/node_modules/@octokit/plugin-rest-endpoint-methods/dist-node/index.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
...
var require_dist_node11 = __commonJS({
  "node_modules/@octokit/core/node_modules/@octokit/endpoint/dist-node/index.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    var isPlainObject = require_is_plain_object();
    var universalUserAgent = require_dist_node();
...
var require_dist_node12 = __commonJS({
  "node_modules/@octokit/core/node_modules/@octokit/request-error/dist-node/index.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    function _interopDefault(ex) {
      return ex && typeof ex === "object" && "default" in ex ? ex["default"] : ex;
...
var require_dist_node14 = __commonJS({
  "node_modules/@octokit/graphql/node_modules/@octokit/endpoint/dist-node/index.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    var isPlainObject = require_is_plain_object();
    var universalUserAgent = require_dist_node();
...
var require_dist_node15 = __commonJS({
  "node_modules/@octokit/graphql/node_modules/@octokit/request-error/dist-node/index.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    function _interopDefault(ex) {
      return ex && typeof ex === "object" && "default" in ex ? ex["default"] : ex;
...
var require_dist_node16 = __commonJS({
  "node_modules/@octokit/graphql/node_modules/@octokit/request/dist-node/index.js"(exports2) {
    ...
    var endpoint = require_dist_node14();
    var universalUserAgent = require_dist_node();
    var isPlainObject = require_is_plain_object();
    var nodeFetch = _interopDefault(require_lib3());
...
var require_dist_node17 = __commonJS({
  "node_modules/@octokit/graphql/dist-node/index.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    var request = require_dist_node16();
    var universalUserAgent = require_dist_node();
    var VERSION = "5.0.5";
    function _buildMessageForResponseErrors(data) {
      return `Request failed due to following response errors:
...
var require_dist_node19 = __commonJS({
  "node_modules/@octokit/core/dist-node/index.js"(exports2, module2) {
    ...
    var import_graphql = require_dist_node17();
    var import_auth_token = require_dist_node18();
    var VERSION = "4.2.4";
    var Octokit2 = class {
      static defaults(defaults) {
        const OctokitWithDefaults = class extends this {
...
var require_dist_node23 = __commonJS({
  "node_modules/@octokit/rest/dist-node/index.js"(exports2, module2) {
    ...
    module2.exports = __toCommonJS2(dist_src_exports);
    var import_core2 = require_dist_node19();
    var import_plugin_request_log = require_dist_node20();
    var import_plugin_paginate_rest = require_dist_node21();
    var import_plugin_rest_endpoint_methods = require_dist_node22();
    var VERSION = "19.0.13";
...
// node_modules/openai-fetch/dist/errors.js
...
// node_modules/openai-fetch/dist/fetch-api.js
var DEFAULT_BASE_URL = "https://api.openai.com/v1";
function createApiInstance(args) {
  const { apiKey, baseUrl, organizationId, kyOptions = {} } = args;
  const { headers, hooks = {}, prefixUrl, retry, timeout: timeout2, ...rest } = kyOptions;
  ...
  hooks.beforeError.push(async (error) => {
    ...
    if (response) {
      ...
      const headers2 = parseHeaders(response.headers);
      let errorResponse;
      let message;
      if (response.body) {
        const errText = await response.clone().text().catch((e) => castToError(e).message);
        errorResponse = safeJson(errText)?.error;
        message = errorResponse ? void 0 : errText;
      }
      return new APIError(status, errorResponse, message, headers2);
    } else {
      return APIError.generate(void 0, error, void 0, void 0);
    }
  });
  return distribution_default.extend({
    ...
    retry: retry ?? {
      delay: (attemptCount) => {
        ...
        return (sleep + jitter) * 1e3;
      }
    },
    timeout: timeout2 ?? 1e3 * 60 * 10,
    hooks,
    ...rest
  });
}
...
// node_modules/openai-fetch/dist/streaming.js
var OpenAIStreamParser = class {
  responseFactory;
  onchunk;
  onend;
  buffer;
  ...
  write(chunk) {
    ...
    parts.map((line) => line.trim()).filter((line) => line.length > 0).forEach((line) => {
...
var StreamCompletionChunker = class {
  writable;
  readable;
  constructor(responseFactory) {
...
// node_modules/openai-fetch/dist/openai-client.js
var OpenAIClient = class {
  api;
  constructor(opts = {}) {
    const process2 = globalThis.process || { env: {} };
    const apiKey = opts.apiKey || process2.env["OPENAI_API_KEY"];
    const organizationId = opts.organizationId || process2.env["OPENAI_ORG_ID"];
    if (!apiKey)
  ...
  async createChatCompletion(params, opts) {
    const response = await this.getApi(opts).post("chat/completions", { json: params }).json();
    return response;
  }
  ...
  async streamChatCompletion(params, opts) {
    const response = await this.getApi(opts).post("chat/completions", {
      ...
      // trick ky to return ReadableStream.
    });
    const stream = response.body;
    return stream.pipeThrough(new StreamCompletionChunker((response2) => response2));
  }
  /** Create completions for an array of prompt strings. */
  async createCompletions(params, opts) {
    const response = await this.getApi(opts).post("completions", { json: params }).json();
    return response;
  }
  ...
  async createEmbeddings(params, opts) {
    const response = await this.getApi(opts).post("embeddings", { json: params }).json();
    return response;
  }
};
...
var _execAsync = (0, import_node_util.promisify)(import_child_process.default.exec);

// src/openai/generate-code-review.ts
async function generateCodeReview(title, body, content) {
...
var import_rest = __toESM(require_dist_node23());
process.on("unhandledRejection", handleError);
async function call(asyncFunction, callOptions = {}) {
  ...
  const github = new import_rest.Octokit({
    auth: token
  });
  const meta = {
    slug: `${import_github.context.repo.owner}/${import_github.context.repo.repo}`
  };
...
function getGitHubToken() {
  const token = process.env.GITHUB_TOKEN ?? core.getInput("github-token", { required: true });
  return token;
}

// src/code-review.ts
var keyword = "Code Review:";
call(async ({ github, context: context2, core: core2 }) => {
  let skip = false;
  if (context2.ref && context2.ref.includes("backport/queue")) {
    skip = true;
  }
  if (skip) {
    return;
  ...
  const title = context2.payload.pull_request?.title;
  const body = context2.payload.pull_request?.body;
  try {
    ...
    const chatGPTComment = comments.data.find(
      (comment) => comment.body.includes(keyword)
    );
    if (chatGPTComment) {
