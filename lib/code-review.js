...
// node_modules/openai-fetch/dist/index.cjs.js
var require_index_cjs = __commonJS({
  "node_modules/openai-fetch/dist/index.cjs.js"(exports, module2) {
    "use strict";
    ...
    __export(src_exports, {
      ChatCompletionParamsSchema: () => ChatCompletionParamsSchema,
      CompletionParamsSchema: () => CompletionParamsSchema,
      EditParamsSchema: () => EditParamsSchema,
      EmbeddingParamsSchema: () => EmbeddingParamsSchema,
    ...
    var OpenAIApiError = class extends BaseError {
      constructor(message, opts = {}) {
    ...
    var EmbeddingParamsSchema = z.object({
      model: EmbeddingModel,
      input: z.string(),
      user: z.string().optional(),
      dontRemoveNewlines: z.boolean().optional()
    });
    var ChatCompletionModel = z.union([
      z.literal("gpt-3.5-turbo"),
      z.literal("gpt-3.5-turbo-0301"),
      z.string()
    ]);
    var ChatMessageRoleSchema = z.union([
      z.literal("system"),
      z.literal("user"),
      z.literal("assistant")
    ]);
    var ChatCompletionRequestMessage = z.object({
      role: ChatMessageRoleSchema,
      content: z.string(),
      name: z.string().nullish()
    });
    var ChatCompletionParamsSchema = z.object({
    ...
    var OpenAIClient2 = class {
      ...
      async createEmbedding(params) {
        ...
        const response = await this.api.post("embeddings", { json: reqBody }).json();
        const embedding = response.data[0].embedding;
        return { embedding, response };
      }
      async createCompletion(params) {
        const reqBody = CompletionParamsSchema.parse(params);
        const response = await this.api.post("completions", { json: reqBody }).json();
        const completion = response.choices[0].text || "";
        return { completion, response };
      }
      async createChatCompletion(params) {
        const reqBody = ChatCompletionParamsSchema.parse(params);
        const response = await this.api.post("chat/completions", { json: reqBody }).json();
      ...
      async createEdit(params) {
        ...
        const response = await this.api.post("edits", { json: reqBody }).json();
        const completion = response.choices[0].text || "";
        return { completion, response };
      }
    };
...
var require_dist_node11 = __commonJS({
  "node_modules/@octokit/core/node_modules/@octokit/endpoint/dist-node/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var isPlainObject = require_is_plain_object();
    var universalUserAgent = require_dist_node();
...
var require_dist_node12 = __commonJS({
  "node_modules/@octokit/core/node_modules/@octokit/request-error/dist-node/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function _interopDefault(ex) {
      return ex && typeof ex === "object" && "default" in ex ? ex["default"] : ex;
...
var require_dist_node13 = __commonJS({
  "node_modules/@octokit/core/node_modules/@octokit/request/dist-node/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function _interopDefault(ex) {
      return ex && typeof ex === "object" && "default" in ex ? ex["default"] : ex;
...
var require_dist_node14 = __commonJS({
  "node_modules/@octokit/graphql/node_modules/@octokit/endpoint/dist-node/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var isPlainObject = require_is_plain_object();
    var universalUserAgent = require_dist_node();
...
var require_dist_node15 = __commonJS({
  "node_modules/@octokit/graphql/node_modules/@octokit/request-error/dist-node/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function _interopDefault(ex) {
      return ex && typeof ex === "object" && "default" in ex ? ex["default"] : ex;
...
var require_dist_node16 = __commonJS({
  "node_modules/@octokit/graphql/node_modules/@octokit/request/dist-node/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function _interopDefault(ex) {
      return ex && typeof ex === "object" && "default" in ex ? ex["default"] : ex;
...
var require_dist_node19 = __commonJS({
  "node_modules/@octokit/core/dist-node/index.js"(exports) {
    ...
    var graphql = require_dist_node17();
...
var require_dist_node23 = __commonJS({
  "node_modules/@octokit/rest/dist-node/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var core2 = require_dist_node19();
    var pluginRequestLog = require_dist_node20();
    var pluginPaginateRest = require_dist_node21();
    var pluginRestEndpointMethods = require_dist_node22();
    var VERSION = "19.0.7";
...
var import_openai_fetch = __toESM(require_index_cjs());
...
async function generateCodeReview(title, body, content) {
  const openai = new import_openai_fetch.OpenAIClient({
...
// src/code-review.ts
var keyword = "ChatGPT Code Review:";
call(async ({ github, context: context2, core: core2 }) => {
  ...
  const title = (_a = context2.payload.pull_request) == null ? void 0 : _a.title;
  const body = (_b = context2.payload.pull_request) == null ? void 0 : _b.body;
  try {
