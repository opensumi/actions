...
var readSummary = async () => {
  if (!process.env.GITHUB_STEP_SUMMARY) {
    return "";
  }
  return (await (0, import_promises.readFile)(process.env.GITHUB_STEP_SUMMARY)).toString();
};
...
`;
  try {
    ...
    console.log(`\u{1F680} ~ file: notifyRCResult.ts ~ line 10 ~ call ~ error`, error);
  }
