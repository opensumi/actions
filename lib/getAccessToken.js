...
call(async ({ github, context: context2, core: core2 }) => {
  const tokenServer = core2.getInput("token-server");
  const flag = core2.getInput("flag");
  ...
  core2.exportVariable("GITHUB_TOKEN", tokenStr);
  core2.setOutput("token", tokenStr);
  core2.setSecret(tokenStr);
});
/*!
